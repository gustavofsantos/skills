...
See `reference.md` for comprehensive rule documentation.
...
- `reference.md`: Comprehensive ast-grep rule documentation covering atomic rules, relational rules, composite rules, and metavariables
